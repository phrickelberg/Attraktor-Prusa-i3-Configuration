...
#define STRING_CONFIG_H_AUTHOR "Moritz Walter" // Who made the changes.
...
#ifdef PIDTEMPBED
//24V AC 500W MK2 with isolator and SSR, 3mm borosilicate + 2mm pei (aluminium frame)
    #define  DEFAULT_bedKp 51.44
    #define  DEFAULT_bedKi 4.51
    #define  DEFAULT_bedKd 146.66
...
#define ABS_PREHEAT_HOTEND_TEMP 275
